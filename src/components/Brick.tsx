  ...
  return (
    ...
    >
      <div className={`flex h-[70vh] ${align ? " flex-row-reverse" : ""} `}>
        <span className="whitespace-pre-line p-10 w-1/2 text-[1.5vw] text-left first-letter:[font-size:3em] first-letter:float-left first-letter:leading-[88%] first-letter:mr-[0.1em] first-letter:[text-shadow:_-0.1em_-0.1em_0.1em_rgb(128_128_128_/_1)]">
          {block.text}
        </span>
